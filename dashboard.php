...
$site->auth();
$uid=$site->uid;
$produts=$site->q("SELECT * FROM products WHERE uid = '$uid' ");
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="add-actions">
                                                    <ul>
                                                        ...
                                                        <li><a class="uren-add_compare" href="products_edit.php?pid=<?=$row['pid'] ?>" data-toggle="tooltip" data-placement="top" title="Edit Phis Product"><i
                                                            class="fa fa-edit"></i></a>
                                                        </li>
                                                        <li><a class="uren-add_compare" href="delete.php?pid=<?=$row['pid'] ?>" data-toggle="tooltip" data-placement="top" title="Delete Phis Product"><i
                                            ...
                                            <div class="product-content">
                                                <div class="product-desc_info">
                                                    ...
                                                    <!-- <div class="delete-btn">
                                                        <a href="btn"><i class="fa fa-trash"></i></a>
                                                    </div> -->
                                                </div>
                                            </div>
                                        </div>
